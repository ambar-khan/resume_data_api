...
capstone = Capstone.create(name: "Bikes", description: "Shows you so many cool bikes that you just get so happy!", url: "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/allbikes-1539286251.jpg?crop=0.659xw:1.00xh;0.317xw,0&resize=640:*", student_id: 1)
capstone = Capstone.create(name: "Read Between", description: "Virtual book discussion app for kool kids.", url: "https://lithub.com/wp-content/uploads/2019/07/used-books-store-2.jpg", student_id: 2)
